...
SECRET_KEY = 'django-insecure-ch468dgg#wwuppu*m3=g!v2(=$+7wyjpk@nkumbt*f_d$+%pd-'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['ec2-18-119-116-91.us-east-2.compute.amazonaws.com']
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles','hrms'
]
